...
import { signInWithEmail, signInWithGoogleAndCreateProfile, signOutUser, mapFirebaseUser } from "@/backend/auth";
...
export default function LoginPage() {
     ...
     const handleLogin = async (e: React.FormEvent) => {
          ...
          try {
               ...
               login(mapFirebaseUser(firebaseUser));
               router.replace("/");
          } catch (err: unknown) {
          ...
          <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
               ...
               >
                    <div className="text-center mb-8">
                         <h2 className="text-[22px] font-medium text-text-primary">Sign in to your account</h2>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                         ...
                         <div>
                              <div className="flex items-center justify-between mb-1.5">
                                   ...
                                   <button type="button" className="text-[12px] text-text-muted hover:text-text-primary transition-colors">
                                        Forgot?
                                   </button>
                              </div>
                    ...
                    <p className="text-center text-[13px] text-text-muted mt-8">
                         ...
                         <Link href="/signup" className="text-text-primary font-medium hover:underline underline-offset-2">
                              Sign up
                         </Link>
                    </p>
               </motion.div>
